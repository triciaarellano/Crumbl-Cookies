...
INSERT INTO `product_table` VALUES (25,'cookies','choco',120,8,'uploads/1.png','Unavailable'),(27,'Pillow cookie','cravings',130,9,'uploads/2.png','Unavailable'),(28,'Cookie Dough','FAVEEEEE',150,12,'uploads/4.png','Unavailable'),(30,'Pink M&Ms','cute',120,43,'uploads/21.png','Unavailable'),(31,'Pink M&Ms','cute',120,43,'uploads/21.png',''),(32,'Rainbow Sparks','funfetti',140,7,'uploads/10.png','Unavailable'),(33,'Chocolate Sprinkles','chocolateee',100,23,'uploads/3.png',''),(34,'pillows','pillow',120,3,'uploads/2.png',''),(35,'pillows','pillow',120,7,'uploads/2.png',''),(36,'pillows','pillow',120,7,'uploads/2.png',''),(37,'Choco Crinkles','crinkleees',100,24,'uploads/22.png',NULL),(38,'Choco Crinkles','crinkles',102,22,'uploads/22.png',NULL),(39,'Lemon Cookie','asim',110,21,'uploads/12.png',NULL),(40,'Lemon Cookie','asim',110,21,'uploads/12.png',NULL),(41,'Blueberry Cookie','berriesss',165,12,'uploads/16.png',NULL),(42,'Blueberry Cookie','berriesss',165,12,'uploads/16.png',NULL),(43,'M&M Cookie','gumana ka',125,15,'uploads/15.png',NULL);
...
INSERT INTO `transaction_table` VALUES (1,NULL,2,'05-09-2024'),(2,NULL,4,'05-09-2024'),(3,NULL,5,'05-09-2024'),(4,NULL,3,'05-10-2024'),(5,NULL,1,'05-10-2024'),(6,NULL,8,'05-10-2024'),(7,NULL,5,'05-10-2024'),(8,NULL,3,'05-11-2024'),(9,NULL,2,'05-11-2024'),(10,NULL,1,'05-12-2024');
...
/*!50001 VIEW `join_logs_user` AS select `u`.`role` AS `role`,`u`.`username` AS `username`,`l`.`action` AS `action`,`l`.`DateTime` AS `DateTime` from (`logs_table` `l` join `user_table` `u` on(`l`.`user_id` = `u`.`user_id`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `join_sales_table` AS select `t`.`quantity_sold` AS `quantity_sold`,`s`.`total_amount` AS `total_amount`,`s`.`payment_method` AS `payment_method`,`s`.`sales_date` AS `sales_date` from (`sales_table` `s` join `transaction_table` `t` on(`s`.`transaction_id` = `t`.`transaction_id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-05-25  3:47:01
