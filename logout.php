...
<div class="login-modal">
  <div class="login-modal-container">
    <div class="login-modal-left">
      <h1 class="login-modal-title">Log out successful!</h1>
      <p class="login-modal-desc">You have successfully logged out of the session.</p>
      <a href="login.php" class="login-link">Go to Log In</a>
    </div>

    <div class="login-modal-right">
      <img src="images/crumbl-login.png" alt="">
    </div>
