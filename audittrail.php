...
<body>
 ...
 <?php
      ...
      if (isset($_POST['search']) && $_POST['search'] != NULL) {
        ...
        $selectsql = "SELECT * FROM logs_table WHERE log_id LIKE '%$searchinput%' OR user_id LIKE '%$searchinput%' OR action LIKE '%$searchinput%' OR DateTime LIKE '%$searchinput%'"; //cHANGE PA 
      } else {
