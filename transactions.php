...
<body>
  ...
  <section class="home">
    ...
    <div class="mainbar-text">Transactions</div>
 ...
 <?php
      ...
      if (isset($_POST['search']) && $_POST['search'] != NULL) {
        ...
        $selectsql = "SELECT * FROM transaction_table WHERE transaction_id LIKE '%$searchinput%' OR product_id LIKE '%$searchinput%' OR quantity_sold LIKE '%$searchinput%' OR transaction_date LIKE '%$searchinput%'"; //cHANGE PA 
      } else {
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete'])) {
        ...
        if(isset($_POST['transaction_id'])) {
            ...
            $delete_query = "DELETE FROM transaction_table WHERE transaction_id = '$transaction_id'";
    ...
    echo "<main class='table' id='transaction_table'>";
         ...
         echo "<section class='table__body'>";
             echo "<table>";
                 echo "<thead>";
                     ...
                     echo "<th>Date <span class='icon-arrow'>&UpArrow;</span></th>";    
                     echo "<th>Action</th>";
                    echo "</tr>";
                 echo "</thead>";
                 echo "<tbody>";
                 foreach ($result as $fielddata) {
                    ...
                    echo "<input type='hidden' name='transaction_id' value='" . $fielddata['transaction_id'] . "'>";
