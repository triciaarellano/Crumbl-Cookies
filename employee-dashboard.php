...
.main-block {
	...
	background-image: url("images/crumbl-employee.png");
  ...
  <div class="side-wrapper">
   ...
   <div class="side-menu">
    <a class="sidebar-link overview is-active" href="employee-dashboard.php">
    ...
    <a class="sidebar-link" href="employee-inventory.php">
